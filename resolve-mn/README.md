...
**897 нэр томьёо · 39 ангилал · 134 товчлуур · 6 ажлын урсгал · 8 хуудасны загвар · 12 нээгддэг цэс**
...
- **12 цэс дарахад үнэхээр нээгдэнэ** — 317 мөр, товчлууртайгаа.
...
└── js/
    ...
    └── dict/
        ...
        └── r21-tses-3.js       View, Playback, Workspace, Help цэс
```
...
- **12 цэсний бүрэн агуулга** — File, Edit, Trim, Timeline, Clip, Mark, View,
  Playback, Color, Fairlight, Workspace, Help. Мөр бүр, тусгаарлагч бүр,
  товчлуур бүр, дэд цэсний сум бүр. Загвар дээр эдгээр цэс үнэхээр нээгдэнэ.
  Нийт **317 мөр**.
- **134 товчлуур** — бүгд цэснээс шууд уншсан.

Хараахан баталгаажуулаагүй: **Fusion цэс** ба Media, Cut, Edit, Color,
Fairlight, Deliver, Photo хуудсуудын дотоод байрлал. Зохиомол агуулга бичээгүй.
