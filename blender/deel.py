...
MOVES = {
    ...
    # Камер хүний замын дундыг тойрон 42 -> 54 м зайд, 7 -> 11 м өндөрт
    # явна; харц нь алхаж яваа хүнийг дагана. Хүн кадрын голд байхад
    # аврагууд 18.6 м хажуу тийш байх тул 35 мм линз хэрэгтэй (шаардах
    # радиус > 36.2 м; 55 мм бол > 56.9 м болно).
    "watch":  {"kind": "follow", "lens": 35.0,
               "center": (12.17, 9.07),          # хүний замын дунд
               "az0": -66.0, "az1": 4.0,         # 70° нум
               "r0": 42.0, "r1": 54.0,
               "z0": 4.20, "z1": 7.00,            # намхан — тэнгэрийн хоосон зай багасна
               "ndc_y": 0.30,
               "hold": 0.1667},
