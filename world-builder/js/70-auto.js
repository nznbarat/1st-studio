...
(function (WB) {
  ...
  AU.buildWorld = async function (idea, cfg) {
    ...
    /* Лавлагаа зураг: харагдацыг зургаас, үйл явдлыг санаанаас авна. */
    const lead = nImg
      ? "Хавсаргасан " + nImg + " лавлагаа зураг" + (idea ? " ба доорх санаа" : "") +
        " дээр үндэслэн бүтэн ертөнцийг зохио."
      : "Доорх санаан дээр үндэслэн бүтэн ертөнцийг зохио.";
    const imgRules = nImg
      ? "- Зургийг НАРИЙН ажигла: хүмүүсийн нас, царай, үс засалт, хувцасны өнгө, материал, хээ, гоёл; " +
        "орчин, цаг үе, цаг агаар, гэрлийн чиглэл, өнгөний палетт, камерын өнцөг.\n" +
        "- Зурагт харагдаж буй хүмүүсийг дүр болгож, гадаад төрх, хувцсыг нь ЯГ зурагт байгаагаар дүрсэл.\n" +
        "- Зурагт харагдаж буй газрыг байршил болго. Зурагт байхгүй зүйлийг зохиохдоо зургийн хэв маягтай нийцүүл.\n" +
        (nImg > 1 ? "- Олон зураг бол бүгдийг нэг ертөнцийн хэсэг гэж үз.\n" : "") +
        (idea ? "- Санаа ба зураг зөрчилдвөл үйл явдлыг санаанаас, харагдацыг зургаас ав.\n" : "")
      : "";
    ...
    const data = await WB.api.askJSON(prompt, 6000, nImg ? { images: images } : undefined);
    return data;
  };
  ...
  AU.pipeline = async function (cfg) {
    ...
    try {
      ...
      step(cfg.images && cfg.images.length
        ? cfg.images.length + " зураг шинжилж, ертөнц зохиож байна…"
        : "Ертөнц зохиож байна…", ++n, total);
